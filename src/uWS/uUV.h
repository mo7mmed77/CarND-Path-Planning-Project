...
void WIN32_EXPORT uv_close(uv_async_t *handle, uv_close_cb cb);
void WIN32_EXPORT uv_close(uv_idle_t *handle, uv_close_cb cb);
void WIN32_EXPORT uv_close(uv_poll_t *handle, uv_close_cb cb);
void WIN32_EXPORT uv_close(uv_timer_t *handle, uv_close_cb cb);

bool WIN32_EXPORT uv_is_closing(uv_async_t *handle);
bool WIN32_EXPORT uv_is_closing(uv_idle_t *handle);
bool WIN32_EXPORT uv_is_closing(uv_poll_t *handle);
bool WIN32_EXPORT uv_is_closing(uv_timer_t *handle);
#else
